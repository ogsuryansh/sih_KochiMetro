        ...
        <Card className="text-center py-16">
          <div className="flex flex-col items-center">
            ...
            <p className="text-gray-400 text-lg mb-6 max-w-md">
              Comprehensive maintenance tracking and scheduling system is coming soon. Keep your fleet in perfect condition.
            </p>
            <div className="inline-flex items-center px-4 py-2 bg-orange-500/20 text-orange-400 rounded-lg text-sm font-medium">
